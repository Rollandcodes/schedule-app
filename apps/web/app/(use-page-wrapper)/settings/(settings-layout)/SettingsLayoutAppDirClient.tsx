...
import { HAS_ORG_OPT_IN_FEATURES } from "@schedule/features/feature-opt-in/config";
import type { TeamFeatures } from "@schedule/features/flags/config";
import { IS_CALCOM, WEBAPP_URL } from "@schedule/lib/constants";
import { getPlaceholderAvatar } from "@schedule/lib/defaultAvatarImage";
import { getUserAvatarUrl } from "@schedule/lib/getAvatarUrl";
import { useIsStandalone } from "@schedule/lib/hooks/useIsStandalone";
...
import { VerticalTabItem } from "@schedule/ui/components/navigation";
