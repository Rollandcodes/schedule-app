...
import { SINGLE_ORG_SLUG } from "@schedule/lib/constants";
import logger from "@schedule/lib/logger";
import { safeStringify } from "@schedule/lib/safeStringify";
import type { RedirectType } from "@schedule/prisma/client";
...
const getTemporaryOrgRedirect = async ({
  ...
  const prisma = (await import("@schedule/prisma")).default;
  log.debug(
