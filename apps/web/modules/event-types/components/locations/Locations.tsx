...
import { getEventLocationType, MeetLocationType } from "@schedule/app-store/locations";
...
import type { LocationFormValues, EventTypeSetupProps } from "@schedule/features/eventtypes/lib/types";
