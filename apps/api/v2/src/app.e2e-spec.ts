import { X_CAL_CLIENT_ID, X_CAL_SECRET_KEY } from "@schedule/platform-constants";
import type { PlatformOAuthClient, RateLimit, Team, User } from "@schedule/prisma/client";
