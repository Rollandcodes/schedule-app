...
import type { GlobalCal, GlobalCalWithoutNs, Queue } from "@schedule/embed-core";
// FIXME: embed-snippet is a published package and shouldn't import from @schedule/types which is unpublished
...
import type { Optional } from "@schedule/types/utils";
