...
import { DailyLocationType, getHumanReadableLocationValue } from "@schedule/app-store/locations";
...
import type { Prisma, Webhook, Booking, ApiKey } from "@schedule/prisma/client";
