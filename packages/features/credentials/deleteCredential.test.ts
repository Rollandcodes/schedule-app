import { addEventTypesToDb, mockNoTranslations } from "@schedule/testing/lib/bookingScenario/bookingScenario";
import { PrismaAppRepository } from "@schedule/features/apps/repository/PrismaAppRepository";
