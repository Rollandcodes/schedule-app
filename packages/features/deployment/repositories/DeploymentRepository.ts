import type { PrismaClient as PrismaClientWithExtensions } from "@schedule/prisma";
import type { PrismaClient as PrismaClientWithoutExtensions } from "@schedule/prisma/client";
