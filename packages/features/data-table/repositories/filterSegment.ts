import type { FilterSegmentOutput, SegmentIdentifier } from "@schedule/features/data-table/lib/types";
import {
  ZActiveFilters,
  ZSortingState,
  ZColumnSizing,
...
import type { UserFilterSegmentPreference } from "@schedule/prisma/client";
