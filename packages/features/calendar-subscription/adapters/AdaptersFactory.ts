import { GoogleCalendarSubscriptionAdapter } from "@schedule/features/calendar-subscription/adapters/GoogleCalendarSubscription.adapter";
import { Office365CalendarSubscriptionAdapter } from "@schedule/features/calendar-subscription/adapters/Office365CalendarSubscription.adapter";
import type { ICalendarSubscriptionPort } from "@schedule/features/calendar-subscription/lib/CalendarSubscriptionPort.interface";
