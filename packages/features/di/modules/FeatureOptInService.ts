import { FEATURE_OPT_IN_DI_TOKENS } from "@schedule/features/feature-opt-in/di/tokens";
import { FeatureOptInService } from "@schedule/features/feature-opt-in/services/FeatureOptInService";
import { moduleLoader as cachedFeatureRepositoryModuleLoader } from "@schedule/features/flags/di/CachedFeatureRepository.module";
import { moduleLoader as cachedTeamFeatureRepositoryModuleLoader } from "@schedule/features/flags/di/CachedTeamFeatureRepository.module";
import { moduleLoader as cachedUserFeatureRepositoryModuleLoader } from "@schedule/features/flags/di/CachedUserFeatureRepository.module";
