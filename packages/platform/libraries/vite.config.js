...
export default defineConfig({
    ...
    rollupOptions: {
      ...
      output: {
        globals: {
          ...
          "@schedule/prisma/client": "@schedule/prisma/client",
        },
      },
    },
  },
  ...
  resolve: {
    ...
    alias: {
      ...
      "@schedule/lib": path.resolve(__dirname, "../../lib"),
      "@schedule/trpc": resolve("../../trpc"),
      "lru-cache": resolve("../../../node_modules/lru-cache/dist/cjs/index.js"),
      "@schedule/prisma/client/runtime/library": resolve("../../prisma/client/runtime/library"),
      "@schedule/prisma/client": resolve("../../prisma/client"),
